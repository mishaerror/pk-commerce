...
import com.pk.commerce.order.event.*;
import com.pk.commerce.order.value.InvalidStateForEventException;
...
public enum OrderState {
    CUSTOMER_INITIATED {
        ...
        public OrderState nextState(OrderEvent event) {
            return switch (event) {
                case CustomerAbandonedOrderEvent customerAbandonedOrderEvent -> CUSTOMER_ABANDONED;
                case CustomerInitiatedOrderEvent customerInitiatedOrderEvent -> CUSTOMER_INITIATED;
                case CustomerEnteredOrderEvent customerEnteredOrderEvent -> CUSTOMER_ENTERED;
